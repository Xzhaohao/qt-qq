...
public:
    ...
    void setupUi(QWidget *TalkWindowShell)
    {
        if (TalkWindowShell->objectName().isEmpty())
            TalkWindowShell->setObjectName(QString::fromUtf8("TalkWindowShell"));
        TalkWindowShell->resize(1043, 730);
        verticalLayout_2 = new QVBoxLayout(TalkWindowShell);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(1, 1, 1, 1);
        splitter = new QSplitter(TalkWindowShell);
        splitter->setObjectName(QString::fromUtf8("splitter"));
        splitter->setStyleSheet(QString::fromUtf8("QSplitter::handle{background-color: rgb(255, 255, 255);}\n"
...
""));
        ...
        leftWidget->setStyleSheet(QString::fromUtf8("QSplitter::handle{\n"
...
"}"));
        ...
        retranslateUi(TalkWindowShell);

        rightStackedWidget->setCurrentIndex(-1);


        QMetaObject::connectSlotsByName(TalkWindowShell);
    } // setupUi

    void retranslateUi(QWidget *TalkWindowShell)
    {
        TalkWindowShell->setWindowTitle(QApplication::translate("TalkWindowShell", "TalkWindowShell", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TalkWindowShell: public Ui_TalkWindowShell {};
} // namespace Ui
